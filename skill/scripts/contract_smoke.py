...
def check_investigation_manifest() -> dict:
    ...
    require(manifest.get("replyDrafting") == "outside_skill", "reply drafting boundary mismatch")
    require(manifest.get("decisionFrame") == {"backgroundOnly": True, "naturalLanguageMayVary": True, "fields": ["sanitized_question", "claim_dispositions", "source_coverage", "accepted_evidence", "conflicts", "unknowns", "route", "next_step_owner"]}, "investigation decision frame mismatch")
